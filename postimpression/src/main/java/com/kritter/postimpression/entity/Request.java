...
public class Request
{
     ...
     */
    @Getter
    private PostImpressionEventUrlReader.POSTIMPRESSION_EVENT_URL_PREFIX postImpressionEvent;
    @Getter
    ...
    public Request(
                   String requestId,
                   PostImpressionEventUrlReader.POSTIMPRESSION_EVENT_URL_PREFIX postImpressionEvent
                  ) throws Exception
    {
