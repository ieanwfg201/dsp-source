...
if [ "$2" = "" ]; then
    SCRIPT_PATH=src/main/pig/reqterminationreason.pig
fi
...
if [ "$4" = "" ]; then
    OUTPUT=/home/rohan/testdata/kritter/out/reqterminationreason
fi
...
MAPRED=/tmp/reqterminationreason_`date +%s`
pig_script=reqterminationreason
