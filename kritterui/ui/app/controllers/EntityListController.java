...
public class EntityListController extends Controller {
            ...
            if (entityListFilter.getEntityType() != null) {
                ...
                switch (entityListFilter.getEntityType()) {
                    ...
                    case audiencemetadata:
                        ...
                        break;
                    case audienceList:
                        entityList = EntityListDataService.listData(entityListFilter, new Audience());
                        populateAudienceList(itemList, (List<Audience>) entityList.getEntityList());
                    default:
                        break;
                }
    ...
    private static void populateAudienceList(ArrayNode entityArray, List<Audience> AudienceList) {
        for (Audience Audience : AudienceList) {
            entityArray.addPOJO(objectMapper.valueToTree(new AudienceDisplay(Audience)));
        }
    }
