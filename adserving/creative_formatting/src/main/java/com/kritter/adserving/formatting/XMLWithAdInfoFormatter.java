...
/**
 * This class formats creatives in xml format sending out extra information
 * such as ecpm value or any other ad information.
 */
public class XMLWithAdInfoFormatter extends XMLFormatter implements CreativesFormatter
{
    ...
    public String formatCreatives(Request request, Response response) throws Exception
    {
        ...
        for(ResponseAdInfo responseAdInfo : response.getResponseAdInfo())
        {
            ...
            {
                fCreative.addTextEntity(creative.getText(), clickUrl.toString(),
                                        cscBeaconUrl.toString(),responseAdInfo.getEcpmValue());
            }
            if(
