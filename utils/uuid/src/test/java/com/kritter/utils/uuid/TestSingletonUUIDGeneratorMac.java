...
public class TestSingletonUUIDGeneratorMac {
    ...
    private static class MultiThreadedUUIDGenerator implements Runnable {
        ...
        @Override
        public void run() {
            IUUIDGenerator uuidGenerator = SingletonUUIDGenerator.getSingletonUUIDGenerator();
    ...
    public void setup(int threadCount) {
        ...
        try {
            ...
            throw new RuntimeException("RuntimeException in UUID MAC test ",e);
        } finally {
