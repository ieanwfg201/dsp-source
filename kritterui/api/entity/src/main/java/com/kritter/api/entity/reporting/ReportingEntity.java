...
public class ReportingEntity {
	 ...
	 * required, integer-pubid element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, String @see com.kritter.constants.HygieneCategory element in
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, String - advertiser guid element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - siteId element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - external site element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - @see com.kritter.constants.SupplySourceTypeEnum
	 * element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - adid element in list signifies filters
	 */
	...
	private List<Integer> marketplace = null;
	/** mandatory - default false - used by hierarchical reporting */
	private boolean marketplace_clickable = false;
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, String - deviceid element in list signifies filters
	 */
	private List<String> deviceId = null;
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - manufacturerid / brand id element in list signifies
	 * filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - model id element in list signifies filters
	 */
	private List<Integer> deviceModelId = null;
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - os id element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - country id element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - carrier id element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - connection typeid @see
	 * com.kritter.constants.ConnectionType element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - country region id element in list signifies filters
	 */
	private List<Integer> countryRegionId = null;
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, integer - exchange id element in list signifies filters
	 */
	...
	/**
	 * mandatory - default null - null means not required, empty list means all
	 * required, String - NoFillReason @see
	 * com.kritter.kumbaya.libraries.data_structs.common.NoFillReason element in
	 * list signifies filters
	 */
	...
	public void setMarketplace(List<Integer> marketplace) {
		this.marketplace = marketplace;
	}

	public boolean isMarketplace_clickable() {
		return marketplace_clickable;
	}

	public void setMarketplace_clickable(boolean marketplace_clickable) {
		this.marketplace_clickable = marketplace_clickable;
	}
	...
	public void setTotal_impression_order_sequence(int total_impression_order_sequence) {
	...
	public void setTotal_win_bidValue_order_sequence(int total_win_bidValue_order_sequence) {
	...
	public void setTotal_event_type_order_sequence(int total_event_type_order_sequence) {
	...
	public int hashCode() {
		...
		result = prime * result + (marketplace_clickable ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (marketplace == null) {
			...
			return false;
		if (marketplace_clickable != other.marketplace_clickable)
			return false;
