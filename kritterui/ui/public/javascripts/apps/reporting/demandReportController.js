...
controller('demandReportController',function ($scope, $http, ngTableParams, $modal) {
	...
	$scope.checkuncheckmetrics = function(checkvalue){
		...
		$('#eCPC').prop("checked",checkvalue);
		$('#billedECPC').prop("checked",checkvalue);
		$('#clicksr').prop("checked",checkvalue);
	...
	var tbparams = new ngTableParams({
        ...
        getData: function($defer, params) {   
        	...
        	var action_url = $('#demandReportConfigForm').attr('action'); 
        	if($scope.getCSV){
	       		action_url = action_url + "/CSV";
	       	}
     		var data = $('#demandReportConfigForm').serialize();
...
var savedReportsController = function ($scope, $modalInstance) {
	  ...
	  $scope.ok = function () {
		  ...
		  var reportConfig = $('#demandReportConfigForm').serializeObject();
