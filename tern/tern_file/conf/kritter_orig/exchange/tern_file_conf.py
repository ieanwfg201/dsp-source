...
# SOURCE DIRECTORY#
source_dir = '/var/log/kritter/adserving/exchange'
#SOURCE FILE PATTERN in unix#
source_file_pattern = 'exchange-thrift.log.2*'
#SOURCE FILE PATTERN in DB#
source_file_pattern_db = '%exchange-thrift.log%'
#DESTINATION HOST PORT#
destination_list = {'localhost' : 22}
#LOG DIRECTORY#
logdir = '/var/log/kritter/tern_file/exchange'
...
destination_path = '/var/data/kritter/tern_file/destination/exchange'
...
sqlite_journal_path = '/var/data/kritter/tern_file/db/exchange/tern_journal.db'
...
source_date_pattern_for_cleanup = '%exchange-thrift.log-%Y-%m-%d'
