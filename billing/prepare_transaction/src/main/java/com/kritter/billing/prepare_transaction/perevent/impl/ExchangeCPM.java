...
public class ExchangeCPM implements IPrepareTransaction {

    private static final Logger LOG = LoggerFactory.getLogger(ExchangeCPM.class);
    ...
    public void prepare_campaign_budget(List<Billing> billingLogList, Connection con,
        ...
        try{
            ...
            if(marketPlaceRset.next()){
                ...
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.EIMP_MP_NF, BillingType.CPM);
                return;
            }
            if(!(marketplace_id == MarketPlace.CPM.getCode())){
                /*Simply return as the Campaign is not CPM*/
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.EIMP_SERVED_CAMP_NOT_CPM, BillingType.CPM);
                preventTransation = true;
                return;
            }
            ...
            if(rset.next()){
                ...
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.EIMP_CAMP_ID_NF, BillingType.CPM);
                preventTransation = true;
                return;
            }
    ...
    public void prepare_account_budget(List<Billing> billingLogList, Connection con,
        ...
        try{
            ...
            if(accountResultSet.next()){
                ...
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.EIMP_ACCOUNT_NF, BillingType.CPM);
                preventTransation = true;
                return;
            }
            if(internal_balance <= 0){
                /*Account NoF*/
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.EIMP_ACCOUNT_NoF, BillingType.CPM);
                preventTransation = true;
                return;
            }
