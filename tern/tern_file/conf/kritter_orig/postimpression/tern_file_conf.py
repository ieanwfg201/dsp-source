...
# SOURCE DIRECTORY#
source_dir = '/var/log/kritter/postimpression/data'
#SOURCE FILE PATTERN in unix#
source_file_pattern = 'postimpression-thrift.log.2*'
#SOURCE FILE PATTERN in DB#
source_file_pattern_db = '%postimpression-thrift.log%'
#DESTINATION HOST PORT#
destination_list = {'localhost' : 22}
#LOG DIRECTORY#
logdir = '/var/log/kritter/tern_file/postimpression'
...
destination_path = '/var/data/kritter/tern_file/destination/postimpression'
...
sqlite_journal_path = '/var/data/kritter/tern_file/db/postimpression/tern_journal.db'
...
source_date_pattern_for_cleanup = '%postimpression-thrift.log-%Y-%m-%d'
