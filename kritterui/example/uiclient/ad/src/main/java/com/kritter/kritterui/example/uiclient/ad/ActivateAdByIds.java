...
public class ActivateAdByIds {
	 ...
	 */
    public static Message activateAds(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        ActivateAdByIds.activateAds(ExampleConstant.url_prefix+ExampleConstant.activate_ad);
    }
}
