...
public class PauseAdByIds {
	 ...
	 */
    public static Message pauseAds(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        PauseAdByIds.pauseAds(ExampleConstant.url_prefix+ExampleConstant.pause_ad);
    }
}
