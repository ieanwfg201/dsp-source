...
public class ListCampaignByAccount {
	/**
	 * Input 
	 ...
	 */
    public static CampaignList getCampaignByAccount(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        ListCampaignByAccount.getCampaignByAccount(ExampleConstant.url_prefix+ExampleConstant.list_campaign);
    }
}
