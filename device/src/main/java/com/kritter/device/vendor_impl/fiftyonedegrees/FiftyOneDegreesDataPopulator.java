package com.kritter.device.vendor_impl.fiftyonedegrees;

import com.kritter.device.HandsetPopulationProvider;
import com.kritter.device.entity.HandsetBrowserData;
import com.kritter.device.entity.HandsetManufacturerData;
import com.kritter.device.entity.HandsetModelData;
import com.kritter.device.entity.HandsetOperatingSystemData;
    ...
    private class DataUploadToDatabaseTimerTask extends TimerTask {
        ...
        public void run() {
            try {
                ...
                logger.error("Exception inside timer task to load data into database inside " +
                        "FiftyOneDegreesDataPopulator",e);
            }
        }
    }
