...
import com.kritter.device.entity.HandsetDataTopLevelKey;
import com.kritter.device.entity.HandsetMasterData;
import com.kritter.device.index.HandsetMakeModelSecondaryIndex;
import com.kritter.device.index.HandsetSecondaryIndexBuilder;
    ...
    implements HandsetDetectionProvider
{
    ...
    private WurflFilesManager wurflFilesManager;
                           ...
                           WurflFilesManager wurflFilesManager) throws InitializationException
    {
        super(secIndexKeyClassList, logger, props, dbMgr,
              prepareQueryMapToSet(wurflFilesManager.getLatestWurflFileVersion()));

        this.wurflFilesManager = wurflFilesManager;
        this.name = cacheName;
    }

    private static Map<Integer,Object> prepareQueryMapToSet(int wurflVersionForDataFetch)
    {
        Map<Integer,Object> map = new HashMap<Integer, Object>();
        map.put(1,wurflVersionForDataFetch);
        return map;
    }
    ...
    {
        return prepareQueryMapToSet(this.wurflFilesManager.getLatestWurflFileVersion());
    }
