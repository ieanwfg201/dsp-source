...
public class CreateVastWrapper {
        ...
        if(linearity == VideoLinearity.LINEAR_IN_STREAM.getCode()){
            ...
            if(companionType != VASTCompanionTypes.Unknown.getCode()){
                ...
                if(clickurl != null || clickTrackers != null){
                	...
                	List<NonLinearClickTracking> nctList = new LinkedList<NonLinearClickTracking>();
                	if(clickurl != null){
                		NonLinearClickTracking nct = new NonLinearClickTracking();
                		nct.setStr(clickurl);
                		nctList.add(nct);
                	}
                	if(clickTrackers != null){
                		for(String s:clickTrackers){
                			if(s != null && !s.isEmpty()){
                				NonLinearClickTracking nct = new NonLinearClickTracking();
                        		nct.setStr(s);
                        		nctList.add(nct);
                	...
                	nonLinear.setNonLinearClickTracking(nctList);
                	nonLinearAds.setNonLinear(nonLinear);
                }
            }
    ...
    public static VastWrapper unMarshallWrapperlVastThreeDotZeroStr(String str,Logger  logger){
    	if(str==null || str.isEmpty()){
    		return null;
    	}
    	try{
    		Unmarshaller jaxbUnmarshaller = GetJaxBContext.getUnMarshallContext().createUnmarshaller();
    ...
    public static String addImpressionsVastStr(String str,Logger logger, LinkedList<String> impressionsTrackers,String id){
    	...
    	VastWrapper wrapper =  unMarshallWrapperlVastThreeDotZeroStr(str,logger);
    	if(wrapper==null){
    		return null;
    	}
    ...
    /*public static void main(String args[]){
    	...
    	System.out.println(CreateVastWrapper.unMarshallWrapperlVastThreeDotZeroStr(s, null));
    }*/
