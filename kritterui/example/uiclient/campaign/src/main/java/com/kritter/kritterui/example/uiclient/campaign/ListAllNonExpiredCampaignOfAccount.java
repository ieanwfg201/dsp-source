...
public class ListAllNonExpiredCampaignOfAccount {
	/**
	 * Input 
	 ...
	 */
    public static CampaignList getAllNonExpiredCampaignOsAccount(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        ListAllNonExpiredCampaignOfAccount.getAllNonExpiredCampaignOsAccount(ExampleConstant.url_prefix+ExampleConstant.nonexpiredlist_campaign);
    }
}
