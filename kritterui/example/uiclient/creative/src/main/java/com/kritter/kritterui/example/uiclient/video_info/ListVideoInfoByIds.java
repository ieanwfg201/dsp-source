...
public class ListVideoInfoByIds {
	/**
	 * Input 
	 ...
	 * 
	 */
    public static VideoInfoList listVideoInfoByIds(String apiUrl) throws Exception{

    	VideoInfoListEntity vile = new VideoInfoListEntity();
    	vile.setId_list("27,28"); /*CSV Ids of video Info*/
    	/*
    	 * Not Required
    	vile.setId();
    ...
    public static void main(String args[]) throws Exception{
        ListVideoInfoByIds.listVideoInfoByIds(ExampleConstant.url_prefix+ExampleConstant.list_videoinfo);
    }
}
