...
destination_path = '/var/data/kritter/tern_file/destination/postimpressionforbilling'
...
sqlite_journal_path = '/var/data/kritter/tern_file/db/postimpressionforbilling/tern_journal.db'
