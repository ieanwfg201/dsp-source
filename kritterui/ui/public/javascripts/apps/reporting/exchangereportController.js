...
controller('exchangereportController',function ($scope, $http, ngTableParams, $modal) {
	$scope.reportType= "";
	...
	var tbparams = new ngTableParams({
      ...
      getData: function($defer, params) {   
		...
		$('#preloader').removeClass("hidden"); 
      	var action_url = $('#exchangereportConfigForm').attr('action'); 
      	if($scope.getCSV){
       		action_url = action_url + "/CSV";
       	}
   		var data = $('#exchangereportConfigForm').serialize();
	...
	$scope.reqState_url = "/metadata/options/reqState";
	$scope.dspNofill_url = "/metadata/options/dspNofill";
	...
	$scope.reqState_msmodel = Object.create(MultiSelectModel);
	$scope.reqState_msmodel.init($scope.reqState_url, 'valueArray', false, true);

	$scope.dspNofill_msmodel = Object.create(MultiSelectModel);
	$scope.dspNofill_msmodel.init($scope.dspNofill_url, 'valueArray', false, true);
