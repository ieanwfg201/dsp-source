...
public class RejectIO {
    ...
    public static Message createIO(String apiUrl) throws Exception{
    	...
    	/*Required*/
    	io.setOrder_number("wdgwq");
    	io.setAccount_guid("011c3e84-ed0b-cb01-495b-2b5cd6000001");
    ...
    public static void main(String args[]) throws Exception{
        RejectIO.createIO(ExampleConstant.url_prefix+ExampleConstant.rejectio);
    }
}
