...
# SOURCE DIRECTORY#
source_dir = '/var/log/kritter/adserving/data'
#SOURCE FILE PATTERN in unix#
source_file_pattern = 'adserving-thrift.log.2*'
#SOURCE FILE PATTERN in DB#
source_file_pattern_db = '%adserving-thrift.log%'
#DESTINATION HOST PORT#
destination_list = {'localhost' : 22}
#LOG DIRECTORY#
logdir = '/var/log/kritter/tern_file/adserving'
...
destination_path = '/var/data/kritter/tern_file/destination/adserving'
...
sqlite_journal_path = '/var/data/kritter/tern_file/db/adserving/tern_journal.db'
...
source_date_pattern_for_cleanup = '%adserving-thrift.log-%Y-%m-%d'
