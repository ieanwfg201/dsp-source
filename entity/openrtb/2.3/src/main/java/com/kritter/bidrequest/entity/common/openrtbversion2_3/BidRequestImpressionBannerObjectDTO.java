...
public class BidRequestImpressionBannerObjectDTO {
    ...
    @JsonProperty("wmax")
    @Setter
    private Integer maxBannerWidthInPixels;

    @JsonIgnore
    public Integer getMaxBannerWidthInPixels(){
        return maxBannerWidthInPixels;
    }
    ...
    @JsonProperty("hmax")
    @Setter
    private Integer maxBannerHeightInPixels;

    /*If included along with a w value then w should be interpreted
      as a recommended or preferred width.*/
    @JsonIgnore
    public Integer getMaxBannerHeightInPixels(){
        return maxBannerHeightInPixels;
    }
    ...
    @JsonProperty("wmin")
    @Setter
    private Integer minBannerWidthInPixels;

    @JsonIgnore
    public Integer getMinBannerWidthInPixels(){
        return minBannerWidthInPixels;
    }
    ...
    @JsonProperty("hmin")
    @Setter
    private Integer minBannerHeightInPixels;

    @JsonIgnore
    public Integer getMinBannerHeightInPixels(){
        return minBannerHeightInPixels;
    }
