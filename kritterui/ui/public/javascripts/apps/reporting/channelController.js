...
controller('channelController',function ($scope, $http, ngTableParams, $modal) {
	$scope.reportType= "";
	...
	var tbparams = new ngTableParams({
      ...
      getData: function($defer, params) {   
		...
		$('#preloader').removeClass("hidden"); 
      	var action_url = $('#channelConfigForm').attr('action'); 
      	if($scope.getCSV){
       		action_url = action_url + "/CSV";
       	}
   		var data = $('#channelConfigForm').serialize();
	...
	$scope.channel_by_pub_url = "/metadata/options/channelbypubids/";
	...
	$scope.channel_msmodel = Object.create(MultiSelectModel);
	$scope.channel_msmodel.init($scope.channel_by_pub_url, 'valueArray', true, true);
	$scope.publishers_msmodel.addDependent("channel", $scope.channel_msmodel);
