...
/**
 * This class ensures if the internal exchange win notification coming from client render is
 * valid or not.
 */
public class InternalExcWinEnricherAndFraudProcessor implements OnlineEnricherAndFraudCheckGroupProcessor
{
    private Logger logger;
    private List<OnlineEnricherAndFraudCheck> onlineEnricherAndFraudChecks;

    public InternalExcWinEnricherAndFraudProcessor(
                                                    String loggerName,
