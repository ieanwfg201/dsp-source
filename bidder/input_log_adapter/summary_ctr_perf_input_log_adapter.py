...
class SummaryCtrPerfInputLogAdapter(GenericInputLogAdapter):
    """
    Class to translate the click summaries to logs as understood by the CTR prediction module
    """
    def __init__(self, dimDelimiter, inDelimiter, dimensions, fieldsDelimiter, timeDimension, timePerWindow, impressionFieldPos, clickFieldPos, predictedCTRFieldPos, isGzipped=0):
        """
        ...
        :param predictedCTRFieldPos: Position in the fields where predicted CTR is found in the summary
        :type predictedCTRFieldPos: int
        ...
        self.predictedCTRFieldPos = predictedCTRFieldPos
    ...
    def parseLogLine(self, line):
        ...
        try:
            ...
            resStr += self.fieldsDelimiter
            resStr += tokens[self.predictedCTRFieldPos]
        except Exception, e:
