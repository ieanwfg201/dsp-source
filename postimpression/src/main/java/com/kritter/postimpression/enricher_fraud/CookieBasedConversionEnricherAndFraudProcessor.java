...
/**
 * This class checks the cookie received (conversion data information) for any
 * problems in the data present inside it.
 */
public class CookieBasedConversionEnricherAndFraudProcessor implements OnlineEnricherAndFraudCheckGroupProcessor
{
    ...
    public CookieBasedConversionEnricherAndFraudProcessor(String loggerName,
    ...
    public OnlineFraudUtils.ONLINE_FRAUD_REASON performOnlineFraudChecks(Context context)
    {
        ...
        ThirdPartyTrackingData thirdPartyTrackingData = thirdPartyTrackingManagerParentObject.
                decipherConversionDataFromTrackingPartner(httpServletRequest,
