...
controller('networkReportController',function ($scope, $http, ngTableParams, $modal) {
	$scope.reportType= "";
	...
	var tbparams = new ngTableParams({
      ...
      getData: function($defer, params) {   
		...
		$('#preloader').removeClass("hidden"); 
      	var action_url = $('#networkReportConfigForm').attr('action'); 
      	if($scope.getCSV){
       		action_url = action_url + "/CSV";
       	}
   		var data = $('#networkReportConfigForm').serialize();
...
var savedReportsController = function ($scope, $modalInstance) {
	  ...
	  $scope.ok = function () {
		  ...
		  var reportConfig = $('#networkReportConfigForm').serializeObject();
