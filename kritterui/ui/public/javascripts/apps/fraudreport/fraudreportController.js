...
controller('fraudreportController',function ($scope, $http, ngTableParams, $modal) {
	...
	var tbparams = new ngTableParams({
      ...
      getData: function($defer, params) {   
		...
		$('#preloader').removeClass("hidden"); 
      	var action_url = $('#fraudreportConfigForm').attr('action'); 
      	if($scope.getCSV){
       		action_url = action_url + "/CSV";
       	}
   		var data = $('#fraudreportConfigForm').serialize();
	...
	$scope.event_url = "/metadata/options/postimp_event";
	...
	$scope.event_msmodel = Object.create(MultiSelectModel);
	$scope.event_msmodel.init($scope.event_url, 'valueArray', false, true);
