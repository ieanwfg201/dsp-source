package com.kritter.kumbaya.libraries.report_delete.monthly;
...
public class MonthlyDelete implements IReportDelete {
    private static Logger m_logger = Logger.getLogger(MonthlyDelete.class);
    
    @Override
    public void delete(String dbhost, String dbuser, String dbpwd,
            String dbname, String dbport, String dbtype, String tablename, int months) throws Exception{
        Date date = new Date();
        date = DateUtils.addHours(date, -months*31*24);
        DateFormat dfm = new SimpleDateFormat("yyyy-MM-01 00:00:00");
    ...
    public static void main(String args[]) throws Exception{
         ...
         * String dbhost, String dbuser, String dbpwd,
            String dbname, String dbport, String dbtype, String tablename, int months
         */
        if(args.length == 8){
            MonthlyDelete hd  = new MonthlyDelete();
