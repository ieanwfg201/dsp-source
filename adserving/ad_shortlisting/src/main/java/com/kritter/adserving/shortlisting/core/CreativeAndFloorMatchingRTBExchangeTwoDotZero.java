...
public class CreativeAndFloorMatchingRTBExchangeTwoDotZero implements CreativeAndFloorMatchingRTBExchange
{
                                                         ...
                                                         ) throws Exception
    {
        logger.debug("Inside processAdUnitsForEachBidRequestImpression of " +
                "CreativeAndFloorMatchingRTBExchangeTwoDotZero");
        ...
        for(BidRequestImpressionDTO bidRequestImpressionDTO : bidRequestImpressionDTOs)
        {
            ...
            if(null == bidRequestImpressionBannerObjectDTO)
            {
                logger.error("BidRequestImpressionBannerObjectDTO is null inside " +
                             "AdShortlistingRTBExchangeTwoDotZero, cannot process " +
            ...
            for(ResponseAdInfo responseAdInfo : response.getResponseAdInfo())
            {
                ...
                {
                    logger.error("Creative format is not banner or richmedia inside AdShortlistingRTBExchangeTwoDotZero, skipping " +
