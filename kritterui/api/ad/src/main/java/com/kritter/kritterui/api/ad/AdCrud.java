...
public class AdCrud {
    ...
    public static Message insert_ad_using_provided_guid(Connection con, Ad ad , boolean createTransaction,
        ...
        try{
            ...
            pstmt.setDouble(20, ad.getExpected_ctr());
            pstmt.setString(21, generateAdvDomain(ad));
            pstmt.setBoolean(22, ad.isIs_frequency_capped());
            pstmt.setInt(23, ad.getFrequency_cap());
            pstmt.setInt(24, ad.getTime_window());
            pstmt.setInt(25, ad.getBidtype());
            pstmt.setString(26, generateExternalTracker(ad));
            pstmt.setString(27, generateExt(ad));
            pstmt.setString(28, generateFreqCap(ad));
            pstmt.setInt(29, ad.getProtocol());
    ...
    public static Message update_ad(Connection con, Ad ad, boolean createTransaction ){
        ...
        try{
            ...
            pstmt.setDouble(18, ad.getExpected_ctr());
            pstmt.setString(19, generateAdvDomain(ad));
            pstmt.setBoolean(20, ad.isIs_frequency_capped());
            pstmt.setInt(21, ad.getFrequency_cap());
            pstmt.setInt(22, ad.getTime_window());
            pstmt.setInt(23, ad.getBidtype());
            pstmt.setString(24, generateExternalTracker(ad));
            pstmt.setString(25, generateExt(ad));
            pstmt.setString(26, generateFreqCap(ad));
            pstmt.setInt(27, ad.getProtocol());
            pstmt.setInt(28, ad.getId());
            int returnCode = pstmt.executeUpdate();
            if(createTransaction){
                con.commit();
            }
