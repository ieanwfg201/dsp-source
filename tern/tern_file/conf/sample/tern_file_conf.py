...
# SOURCE DIRECTORY#
source_dir = '/usr/share/kritter/tern_file/bin'
#SOURCE FILE PATTERN in unix#
source_file_pattern = 'tern*.py'
#SOURCE FILE PATTERN in DB#
source_file_pattern_db = '%tern%.py%'
#DESTINATION HOST PORT#
destination_list = {'localhost' : 22}
#LOG DIRECTORY#
logdir = '/var/log/kritter/tern_file/'
...
sqlite_journal_path = '/usr/share/kritter/tern_file/db/tern_journal.db'
...
source_date_pattern_for_cleanup = 'tern-%Y'
