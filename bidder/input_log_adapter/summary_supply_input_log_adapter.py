...
class SummarySupplyInputLogAdapter(GenericInputLogAdapter):
    def __init__(self, dimDelimiter, fieldsDelimiter, dimensions, inDelimiter, requestFieldPos, timeDimension = -1, timePerWindow = 0, isGzipped = 1):
        """  Constructor
            ...
            :param requestFieldPos: Position in the fields where request is found in the summary
            :type requestFieldPos: int
        ...
        self.requestFieldPos = requestFieldPos
    ...
    def parseLogLine(self, line):
        ...
        try:
            ...
            resStr += tokens[self.requestFieldPos]
        except Exception, e:
...
if __name__ == '__main__':
    ...
    obj = SummarySupplyInputLogAdapter(dimDelimiter, fieldsDelimiter, dimensions, inDelimiter)
