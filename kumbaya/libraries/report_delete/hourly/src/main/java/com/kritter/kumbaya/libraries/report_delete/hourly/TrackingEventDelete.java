...
public class TrackingEventDelete implements IReportDelete {
    private static Logger m_logger = Logger.getLogger(TrackingEventDelete.class);
    ...
    public static void main(String args[]) throws Exception{
         ...
         */
        if(args.length == 8){
            TrackingEventDelete hd  = new TrackingEventDelete();
