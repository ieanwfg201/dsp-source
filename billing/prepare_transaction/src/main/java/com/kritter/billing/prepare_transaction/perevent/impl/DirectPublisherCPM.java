...
public class DirectPublisherCPM implements IPrepareTransaction {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(DirectPublisherCPM.class);
    ...
    public void prepare_campaign_budget(List<Billing> billingLogList, Connection con,
        ...
        try{
            ...
            if(marketPlaceRset.next()){
                ...
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.DPIMP_MP_NF, BillingType.CPM);
                return;
            }
            if(!(marketplace_id == MarketPlace.CPM.getCode())){
                /*Simply return as the Campaign is not CPM*/
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.DPIMP_SERVED_CAMP_NOT_CPM, BillingType.CPM);
                preventTransation = true;
                return;
            }
            ...
            if(rset.next()){
                ...
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.DPIMP_CAMP_ID_NF, BillingType.CPM);
                preventTransation = true;
                return;
            }
    ...
    public void prepare_account_budget(List<Billing> billingLogList, Connection con,
        ...
        try{
            ...
            if(accountResultSet.next()){
                ...
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.DPIMP_ACCOUNT_NF, BillingType.CPM);
                preventTransation = true;
                return;
            }
            if(internal_balance <= 0){
                /*Account NoF*/
                AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.DPIMP_ACCOUNT_NoF, BillingType.CPM);
                preventTransation = true;
                return;
            }
        ...
        try{
            ...
            if(payoutRset.next()){
                ...
                if(siteRset.next()){
                    ...
                    /*Site Id Not Found*/
                    AddBilling.createNaddTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.DPIMP_SITE_ID_NF, BillingType.CPC);
                    preventTransation = true;
                    return;
                }
            }
    ...
    public void prepare_updates(List<Billing> billingLogList, Connection con, PostImpressionRequestResponse pirr) throws Exception{
        ...
        try{
            ...
            campaignStmt.setDouble(1, internal_total_burn + (pirr.getInternal_max_bid()/1000));
            campaignStmt.setDouble(2, adv_total_burn + (pirr.getAdvertiser_bid()/1000));
            campaignStmt.setDouble(3, internal_daily_burn + (pirr.getInternal_max_bid()/1000));
            campaignStmt.setDouble(4, adv_daily_burn + (pirr.getAdvertiser_bid()/1000));
            ...
            accountStmt.setDouble(1, internal_balance - (pirr.getInternal_max_bid()/1000));
            accountStmt.setDouble(2, internal_burn + (pirr.getInternal_max_bid()/1000));
            accountStmt.setDouble(3, adv_balance - (pirr.getAdvertiser_bid()/1000));
            accountStmt.setDouble(4, adv_burn + (pirr.getAdvertiser_bid()/1000));
             ...
             */
                ...
                eventPayOut = (payoutPercent * pirr.getInternal_max_bid())/100000;
                ...
                AddBilling.createNaddNonTerminatedBillingObject(billingLogList, pirr, BillingTerminationReason.HEALTHY_REQUEST, BillingType.CPM, this);
            }else{
                /**
