...
public class ActivateCampaign {
	 ...
	 */
    public static Message activateCampaign(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        ActivateCampaign.activateCampaign(ExampleConstant.url_prefix+ExampleConstant.activate_campaign);
    }
}
