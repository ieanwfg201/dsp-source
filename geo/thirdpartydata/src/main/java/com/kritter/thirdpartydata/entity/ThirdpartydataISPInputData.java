...
/**
 * This class represents isp input data as obtained by thirdpartydata
 * as CSV database file having format:
 *
 * startIpLongValue,endIpLongValue,ispNameWithQuotes.
 */

public class ThirdpartydataISPInputData
{
    @Getter
    ...
    public ThirdpartydataISPInputData(BigInteger startIpValue,
    ...
    public boolean equals(Object obj)
    {
        ...
        ThirdpartydataISPInputData externalObject = (ThirdpartydataISPInputData) obj;
