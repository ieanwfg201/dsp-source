...
public class GetAdvAccount {
	 ...
	 * @throws Exception
	 */
    public static AccountMsgPair getAdvertiser(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        GetAdvAccount.getAdvertiser(ExampleConstant.url_prefix+ExampleConstant.get_adv);
    }
