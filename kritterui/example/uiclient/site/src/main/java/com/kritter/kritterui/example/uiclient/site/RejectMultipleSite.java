...
public class RejectMultipleSite {
	/**
	 * Input 1 
	 ...
	 */
	public static Message rejectMultipleSite(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        RejectMultipleSite.rejectMultipleSite(ExampleConstant.url_prefix+ExampleConstant.reject_multiple_site);
    }
}
