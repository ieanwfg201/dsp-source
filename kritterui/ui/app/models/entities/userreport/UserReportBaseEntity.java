...
public class UserReportBaseEntity {
    ...
    protected UserReport userReport = new UserReport();

    public UserReportBaseEntity(UserReport userReport) {
        this.userReport = userReport;
        if (userReport == null
                || userReport.getStart_time_str() == null
        ...
        if (userReport == null
                || userReport.getEnd_time_str() == null
    ...
    public void setStart_date(String start_date) {
        userReport.setStart_time_str(start_date);
    }
    ...
    public void setEnd_date(String end_date) {
        userReport.setEnd_time_str(end_date);
    }
