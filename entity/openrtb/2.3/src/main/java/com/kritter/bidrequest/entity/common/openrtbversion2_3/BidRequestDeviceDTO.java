...
public class BidRequestDeviceDTO {
    ...
    @Setter
    private String hashedSHA1MacAddressOfDevice;

    @JsonIgnore
    public String getHashedSHA1MacAddressOfDevice(){
        return hashedSHA1MacAddressOfDevice;
    }

    /*MAC address of the device; hashed via MD5.*/
    @JsonProperty("macmd5")
    @Setter
    private String hashedMD5MacAddressOfDevice;

    @JsonIgnore
    public String getHashedMD5MacAddressOfDevice(){
        return hashedMD5MacAddressOfDevice;
    }
    ...
    @JsonProperty("h")
    @Setter
    private Integer devicePhysicalHeightInPixels;

    @JsonIgnore
    public Integer getDevicePhysicalHeightInPixels(){
        return devicePhysicalHeightInPixels;
    }

    /*Physical width of the screen in pixels.*/
    @JsonProperty("w")
    @Setter
    private Integer devicePhysicalWidthInPixels;

    @JsonIgnore
    public Integer getDevicePhysicalWidthInPixels(){
        return devicePhysicalWidthInPixels;
    }

    /*Screen size as pixels per linear inch.*/
    @JsonProperty("ppi")
    @Setter
    private Integer screenSizeInPixelsPerLinearInch;

    @JsonIgnore
    public Integer getScreenSizeInPixelsPerLinearInch(){
        return screenSizeInPixelsPerLinearInch;
    }

    /*The ratio of physical pixels to device independent pixels.*/
    @JsonProperty("pxratio")
    @Setter
    private Float physicalToIndependentPixelsRatio;

    @JsonIgnore
    public Float getPhysicalToIndependentPixelsRatio(){
        return physicalToIndependentPixelsRatio;
    }
