...
public class EditCampaign {
    ...
    public static void main(String args[]) throws Exception{
        EditCampaign.editCampaign(ExampleConstant.url_prefix+ExampleConstant.edit_campaign);
    }
}
