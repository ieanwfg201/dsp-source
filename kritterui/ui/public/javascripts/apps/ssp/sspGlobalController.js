...
controller('sspGlobalController',function ($scope, $http, ngTableParams, $modal) {
    ...
    $scope.addedit = function () {
        var action_url = '/ssp/global/update'; 
        var data = $('#sspGlobalConfigForm').serialize();
       ...
       getData: function($defer, params) {   
		   ...
		   if($scope.reset){
			...
			$('#preloader').removeClass("hidden"); 
	       	...
	       	var action_url = $('#sspGlobalConfigForm').attr('action'); 
	       	var data = $('#sspGlobalConfigForm').serialize();
	    		$http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
	    		$http.post(action_url, data).success( function(response){ 
