...
public class ListAdsByMultipleCampaigns {
	/**
	 * Input 
	 ...
	 */
    public static AdList getAdsByMultipleCampaign(String apiUrl) throws Exception{
    	AdListEntity ale = new AdListEntity();
    	ale.setId_list("52,53"); /*Campaign Ids*/
    ...
    public static void main(String args[]) throws Exception{
        ListAdsByMultipleCampaigns.getAdsByMultipleCampaign(ExampleConstant.url_prefix+ExampleConstant.listadbymultiplecampaigns);
    }
}
