...
controller('globalHierarchyController',function ($scope, $http, ngTableParams, $modal) {
	$scope.chartData= {};
	$scope.reportType= "";
       ...
       getData: function($defer, params) {   
		   ...
		   if($scope.reset){
			...
			$('#preloader').removeClass("hidden"); 
	       	...
	       	var action_url = $('#globalHierarchyReportForm').attr('action'); 
	       	if($scope.getCSV){
	       		action_url = action_url + "/CSV";
	       	}
	       	var data = $('#globalHierarchyReportForm').serialize();
