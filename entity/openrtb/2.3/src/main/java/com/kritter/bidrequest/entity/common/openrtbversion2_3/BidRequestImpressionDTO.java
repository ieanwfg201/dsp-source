...
public class BidRequestImpressionDTO {
    ...
    /* A Native object (Section 3.2.5); required if this impression is offered as
     * a native ad opportunity.*/
    @JsonProperty("native")
    @Setter
    private BidRequestImpressionNativeObjectDTO bidRequestImpressionNativeObjectDTO;

    @JsonIgnore
    public BidRequestImpressionNativeObjectDTO getBidRequestImpressionNativeObjectDTO(){
        return bidRequestImpressionNativeObjectDTO;
    }
