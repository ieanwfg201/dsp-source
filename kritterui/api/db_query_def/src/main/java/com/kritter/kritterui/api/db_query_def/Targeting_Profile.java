...
public class Targeting_Profile {
    ...
    public static final String insert_targeting_profile = "insert into targeting_profile(guid,name,account_guid,status_id,brand_list," +
    		...
    		+ "pmp_deal_json,device_type,ext,lat_lon_radius_file,deviceid_file,lat_lon_radius_unit,user_id_inc_exc,audience_targeting,audience_targeting_def,audience_tags)" +
    		" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public static final String update_targeting_profile = "update targeting_profile set name=?,status_id=?,brand_list=?," +
            ...
            + "lat_lon_radius_file=?,deviceid_file=?,lat_lon_radius_unit=?,user_id_inc_exc=?,audience_targeting=?,audience_targeting_def=?,audience_tags=? where guid=?";
    ...
    public static final String get_targeting_profile_by_id = "select * from targeting_profile where id = ?";
    ...
    public static final String insert_targeting_profile_limited_parameters = "insert into targeting_profile(guid,name,account_guid,status_id,brand_list," +
            ...
            "category_list,is_category_list_excluded,custom_ip_file_id_set,modified_by," +
            "last_modified,supply_source_type,supply_source,geo_targeting_type," +
            "hours_list,midp,lat_long,exchange_supply_inc_exc,connection_type_targeting_json,tablet_targeting,supply_inc_exc, retargeting,pmp_deal_json,lat_lon_radius_unit)" +
            " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
