...
/**
 * This class ensures if the win notification coming from client render is
 * valid or not.
 */
public class WinNotificationEnricherAndFraudProcessor implements OnlineEnricherAndFraudCheckGroupProcessor
{
    private Logger logger;
    private List<OnlineEnricherAndFraudCheck> onlineEnricherAndFraudChecks;

    public WinNotificationEnricherAndFraudProcessor(
                                                    String loggerName,
