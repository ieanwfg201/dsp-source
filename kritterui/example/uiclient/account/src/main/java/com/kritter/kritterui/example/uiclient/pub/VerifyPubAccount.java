...
public class VerifyPubAccount {
	 ...
	 * @throws Exception
	 */
    public static Message verifyPubAccountByUserIdOrEmail(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        VerifyPubAccount.verifyPubAccountByUserIdOrEmail(ExampleConstant.url_prefix+ExampleConstant.verify_pub);
    }
}
