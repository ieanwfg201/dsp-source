...
# SOURCE DIRECTORY#
source_dir = '/var/log/kritter/adserving/adstats'
#SOURCE FILE PATTERN in unix#
source_file_pattern = 'adstats-thrift.log.2*'
#SOURCE FILE PATTERN in DB#
source_file_pattern_db = '%adstats-thrift.log%'
#DESTINATION HOST PORT#
destination_list = {'localhost' : 22}
#LOG DIRECTORY#
logdir = '/var/log/kritter/tern_file/adstats'
...
destination_path = '/var/data/kritter/tern_file/destination/adstats'
...
sqlite_journal_path = '/var/data/kritter/tern_file/db/adstats/tern_journal.db'
...
source_date_pattern_for_cleanup = '%adstats-thrift.log-%Y-%m-%d'
