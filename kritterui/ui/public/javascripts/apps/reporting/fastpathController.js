...
controller('fastpathController',function ($scope, $http, ngTableParams, $modal) {
	$scope.reportType= "";
	...
	var tbparams = new ngTableParams({
      ...
      getData: function($defer, params) {   
		...
		$('#preloader').removeClass("hidden"); 
      	var action_url = $('#fastpathConfigForm').attr('action'); 
      	if($scope.getCSV){
       		action_url = action_url + "/CSV";
       	}
   		var data = $('#fastpathConfigForm').serialize();
