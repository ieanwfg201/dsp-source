...
public class AdStatDailyDelete implements IReportDelete {
    private static Logger m_logger = Logger.getLogger(AdStatDailyDelete.class);
    ...
    public static void main(String args[]) throws Exception{
         ...
         */
        if(args.length == 8){
            AdStatDailyDelete hd  = new AdStatDailyDelete();
