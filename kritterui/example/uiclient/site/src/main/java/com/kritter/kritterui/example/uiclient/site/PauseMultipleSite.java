...
public class PauseMultipleSite {
	/**
	 * Input 1 
	 ...
	 */
	public static Message pauseMultipleSite(String apiUrl) throws Exception{
    ...
    public static void main(String args[]) throws Exception{
        PauseMultipleSite.pauseMultipleSite(ExampleConstant.url_prefix+ExampleConstant.pause_multiple_site);
    }
}
