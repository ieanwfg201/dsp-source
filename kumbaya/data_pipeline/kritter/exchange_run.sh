...
if [ "$2" = "" ]; then
    SCRIPT_PATH=src/main/pig/exchange.pig
fi

if [ "$3" = "" ]; then
    INPUT_FILES=/home/rohan/testdata/kritter/exchange*
fi

if [ "$4" = "" ]; then
    OUTPUT=/home/rohan/testdata/kritter/out/exchangehourly
fi
