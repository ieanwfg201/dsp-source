...
public class ConvertRequest {
    ...
    public static VamBidRequestParentNodeDTO convert(VamRequest request){
        ...
        if(request.getVamVideo().getExcludedAdvList()!= null && request.getVamVideo().getExcludedAdvList().size()>0) {
        ...
        if(request.getDisplay(0).getExcludedAdvList()!= null && request.getDisplay(0).getExcludedAdvList().size()>0) {
        ...
        if(request.getVamMobileVideo().getExcludedAdvList()!= null && request.getVamMobileVideo().getExcludedAdvList().size()>0) {
    ...
    public static void device(VamRequest request){
        ...
        if(request.hasDeviceType()){
            switch (request.getDeviceType().getNumber()){
                case 0 : device.setDeviceType(2);break;
                case 1 : device.setDeviceType(1);break;
                case 2 : device.setDeviceType(5);break;
                case 3 : device.setDeviceType(3);break;
            }
        }
        ...
        if(request.getVamMobile().hasOs()){
            if(request.getVamMobile().getOs()==1){
                ...
                device.setDeviceOperatingSystem("其他");
            }
        ...
        if(request.getVamMobile().hasOperateId()){
            switch (request.getVamMobile().getOperateId()){
                case 0 : device.setCarrier("未识别");
                case 1 : device.setCarrier("移动");
                case 2 : device.setCarrier("联通");
                case 3 : device.setCarrier("电信");
            }
        }
