...
public class Targeting_Profile {
    ...
    public static final String insert_targeting_profile = "insert into targeting_profile(guid,name,account_guid,status_id,brand_list," +
    		...
    		"hours_list,midp,lat_long,exchange_supply_inc_exc,connection_type_targeting_json,tablet_targeting,supply_inc_exc, retargeting,pmp_deal_json,device_type)" +
    		" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public static final String update_targeting_profile = "update targeting_profile set name=?,status_id=?,brand_list=?," +
            ...
            "connection_type_targeting_json=?,tablet_targeting=?,supply_inc_exc=?,retargeting=?,pmp_deal_json=?,device_type=? where guid=?";
