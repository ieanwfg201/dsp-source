...
public class MetadataController extends Controller {
    ...
    @SecuredAction
    public static Result audience_tags_list() {
        ArrayNode publisherOptions = MetadataAPI.audience_tags_list();
        return ok(publisherOptions);
    }

    @SecuredAction
    public static Result audienceInc(String account_guid) {
        ArrayNode publisherOptions = MetadataAPI.audienceInc(account_guid);
        return ok(publisherOptions);
    }

    @SecuredAction
    public static Result audienceExc(String account_guid) {
        ArrayNode publisherOptions = MetadataAPI.audienceExc(account_guid);
        return ok(publisherOptions);
    }

    @SecuredAction
    public static Result audiencePackage(String account_guid) {
        ArrayNode publisherOptions = MetadataAPI.aaudiencePackage(account_guid);
        return ok(publisherOptions);
    }
}
