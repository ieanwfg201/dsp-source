...
public class DoubleClickCrypto {
  ...
  {
      byte[] encryptionKey = {
              (byte) 0x42, (byte) 0xf7, (byte) 0x01, (byte) 0x27, (byte) 0xff,
              (byte) 0x56, (byte) 0xc1, (byte) 0xf4, (byte) 0x6a, (byte) 0x18,
              (byte) 0x98, (byte) 0x0c, (byte) 0xad, (byte) 0x0e, (byte) 0xbd,
              (byte) 0xc5, (byte) 0xb0, (byte) 0xb5, (byte) 0x77, (byte) 0xd8,
              (byte) 0x5f, (byte) 0x87, (byte) 0x9b, (byte) 0xfa, (byte) 0x6e,
              (byte) 0x06, (byte) 0xda, (byte) 0x75, (byte) 0x11, (byte) 0x7a,
              (byte) 0x53, (byte) 0x92
      };

      byte[] integrityKey = {
              (byte) 0x3a, (byte) 0x1b, (byte) 0xf8, (byte) 0x1b, (byte) 0x97,
              (byte) 0x1b, (byte) 0x2a, (byte) 0x22, (byte) 0x1c, (byte) 0x35,
              (byte) 0x11, (byte) 0x23, (byte) 0x31, (byte) 0xc7, (byte) 0xc9,
              (byte) 0x3d, (byte) 0x44, (byte) 0x60, (byte) 0x67, (byte) 0x68,
              (byte) 0x25, (byte) 0x55, (byte) 0x63, (byte) 0xe0, (byte) 0x9a,
              (byte) 0x50, (byte) 0xa9, (byte) 0xac, (byte) 0x70, (byte) 0xb1,
              (byte) 0x4a, (byte) 0x2e
      };

      char encryption_key[] = {
              0x42, 0xf7, 0x01, 0x27, 0xff,
              0x56, 0xc1, 0xf4, 0x6a, 0x18,
              0x98, 0x0c, 0xad, 0x0e, 0xbd,
              0xc5, 0xb0, 0xb5, 0x77, 0xd8,
              0x5f, 0x87, 0x9b, 0xfa, 0x6e,
              0x06, 0xda, 0x75, 0x11, 0x7a,
              0x53, 0x92
      };

      SecretKeySpec encryptionKey1 = new SecretKeySpec(encryptionKey,"HMAC");
      SecretKeySpec integrityKey1 = new SecretKeySpec(integrityKey,"HMAC");

      Keys keys1 = new Keys(encryptionKey1,integrityKey1);

      Price price  = new Price(keys1);

      long t = System.currentTimeMillis();

      price.decodePriceMicros("VYraoAAEQlsKaRETAAe7i39PyFlBAJbFx5RKng");

      System.out.println((System.currentTimeMillis() - t));

      System.out.println(price.decodePriceMicros("VYraoAAEQnAKaRETAAe7iyWfl3S8ke4Zxfu87w"));

      System.out.println(price.decodePriceMicros("VYraoAAEQnUKaRETAAe7i8K6Tz_xaDh0QuYy9A"));


      Base64 base64Encoder = new Base64(0);
      String enc = new String(base64Encoder.encode(encryptionKey));
      String inc = new String(base64Encoder.encode(integrityKey));
      System.out.println(enc);
      System.out.println(inc);

      byte[] enc1 = base64Encoder.decode(enc);
      byte[] inc1 = base64Encoder.decode(inc);

      System.out.println(new String(base64Encoder.encode(enc1)));
      System.out.println(new String(base64Encoder.encode(inc1)));
