...
bidFloor as bidFloor;

limited_group_data =  GROUP limited_convert_data BY (PROCESS_TIME, time, pub_inc_id, siteId, deviceManufacturerId, deviceOsId, countryId, countryCarrierId, adId, campaignId, adv_inc_id,marketplace);
