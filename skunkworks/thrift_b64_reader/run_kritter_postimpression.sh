...
if [ "$2" = "" ]; then
    THRIFTCLASS=com.kritter.postimpression.thrift.struct.PostImpressionRequestResponse
fi
...
echo "#####################################################"
echo "################## EXAMPLE USAGE ####################"
echo "./run_kritter_postimpression.sh \"/var/log/kritter/postimpression/data/postimpression-thrift.log.2014-07-22-12-51\""
echo "#####################################################"
