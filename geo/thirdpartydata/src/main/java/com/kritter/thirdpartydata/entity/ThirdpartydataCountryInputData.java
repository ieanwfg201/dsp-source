...
/**
 * This class models essential data from thirdpartydata database.
 */
public class ThirdpartydataCountryInputData
{
    @Getter
    ...
    public ThirdpartydataCountryInputData(BigInteger startIpValue,
                                   BigInteger endIpValue,
                                   String countryTwoLetterCode,
                                   String countryName, String dataSourceName)
    {
